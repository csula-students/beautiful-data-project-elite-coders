...
public class QuizESApp {
    private final static String indexName = "movies-data";
    ...
    public static void main(String[] args) throws URISyntaxException, IOException {
        ...
        File csv = new File(
            ClassLoader.getSystemResource("ratings.csv")
                .toURI()
        );
    ...
    static class Salary {
        ...
        public Salary(long userid, int movieid, double ratings, int year) {
            this.userId = userid;
