 ...
 * ```
 ...
 ```
 */
public class ApptagMovies {
    private final static String indexName = "movies-data-tag";
    ...
    public static void main(String[] args) throws URISyntaxException, IOException {
        ...
        File csv = new File(
            ClassLoader.getSystemResource("tagmovies.csv")
                .toURI()
        );
    ...
    static class Salary {
        ...
        public Salary(long userid, int movieid, int year,String tag,String title) {
            this.userId = userid;
